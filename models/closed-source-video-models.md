...
[← Mago video models](mago-video-models.md) · [Model catalog](README.md) · [Image models →](image-models.md)
...
- **Instruction-based prompts** — tell the model what to do, not what the result should look like. ([Why?](../guide/prompting-guide.md))
...
- **Character reference:** required. A full-body reference works even for close-ups, though [Modify Frame](../guide/workspaces/modify-frame.md) preparation gives better results.
