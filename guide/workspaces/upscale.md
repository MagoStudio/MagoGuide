...
[← Mask](/guide/workspaces/mask) · [Workspaces](/guide/overview#the-five-workspaces) · [Next: Global Timeline →](/guide/workspaces/global-timeline)
...
1. Validate the look in [Modify Frame](/guide/workspaces/modify-frame).
