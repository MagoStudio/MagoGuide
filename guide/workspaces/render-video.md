...
[← User Guide](../index) · [Workspaces](../index#the-five-workspaces) · [Next: Modify Frame →](modify-frame)
...
The single most important setting — the chosen model determines what the rest of the panel exposes. See the [Model catalog](../../models/index) and the [decision tree](../../models/index#decision-tree).
