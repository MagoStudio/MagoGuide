...
[← Modify Frame](modify-frame.md) · [Workspaces](../README.md#the-five-workspaces) · [Next: Upscale →](upscale.md)

---

The Mask workspace generates masks — definitions of which parts of a video get edited and which stay intact. Masks are used primarily by [Mago Inpaint](../../models/mago-video-models.md#mago-inpaint), but can also be downloaded for external compositing.
...
> **⚠️ Warning** — Don't use a mask when the *entire* frame needs to transform. Use [Mago Transform](../../models/mago-video-models.md#mago-transform) or [Mago Style Transfer](../../models/mago-video-models.md#mago-style-transfer) instead.
